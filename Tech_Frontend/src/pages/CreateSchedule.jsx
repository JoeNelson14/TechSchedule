    ...
    <div className="p-6 max-w-3xl mx-auto">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <section className="bg-white shadow rounded p-4 space-y-3">
          ...
          <input className="border rounded p-2 w-full" placeholder="Title (e.g., Oil Change)" value={title} onChange={(e) => setTitle(e.target.value)} required/>
          <textarea className="border rounded p-2 w-full" placeholder="Description (optional)" value={description} onChange={(e) => setDescription(e.target.value)} rows={3}/>
        </section>
